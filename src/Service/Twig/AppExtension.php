...
class AppExtension extends AbstractExtension
{
    ...
    {
        return [
            new \Twig_Function('getCategories', function () {//dans twig.yaml dans "globals: category_service:
                //'@App\Repository\CategoryRepository' est défini. Cette fonction fait apparaitre uniquement les catégories
                //qui possèdent des articles
